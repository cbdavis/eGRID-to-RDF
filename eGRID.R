...
if (file.exists('eGRID_All_Files_Year_1996_thru_2010_data.zip') == FALSE) {
  download.file('http://www.epa.gov/cleanenergy/documents/egridzips/eGRID_All_Files_Year_1996_thru_2010_data.zip', 'eGRID_All_Files_Year_1996_thru_2010_data.zip')
}
unzip('eGRID_All_Files_Year_1996_thru_2010_data.zip')
...
eGRID_2010_plants <- cleanHeaders(readWorksheetFromFile('eGRID_9th_edition_V1-0_year_2010_Data.xls',
                                                        sheet = 4, header = TRUE, startCol = 1, startRow = 5, endCol=0, endRow=0))
eGRID_2010_plants$year = 2010
xlcFreeMemory()
...
eGRID_2010_boilers <- cleanHeaders(readWorksheetFromFile('eGRID_9th_edition_V1-0_year_2010_Data.xls',
                                                        sheet = 2, header = TRUE, startCol = 1, startRow = 6, endCol=0, endRow=0))
eGRID_2010_boilers$year = 2010
xlcFreeMemory()
...
eGRID_2010_generators <- cleanHeaders(readWorksheetFromFile('eGRID_9th_edition_V1-0_year_2010_Data.xls',
                                                         sheet = 3, header = TRUE, startCol = 1, startRow = 6, endCol=0, endRow=0))
eGRID_2010_generators$year = 2010
xlcFreeMemory()
...
eGRID_all_years_generators <- rbind.fill(eGRID_1996_generators, 
                                         ...
                                         eGRID_2010_generators)

#clean up after ourselves - these are not needed anymore
rm(list=c('eGRID_1996_generators', 
          'eGRID_1997_generators', 
          'eGRID_1998_generators', 
          'eGRID_1999_generators', 
          'eGRID_2000_generators', 
